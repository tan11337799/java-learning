...
public class FruitService {
    ...
    public int getFruitCount(String keyword){
        return fruitDAO.selectCount(keyword);
    }
    public List<Fruit> findAllFruit(){
        return fruitDAO.findAll();
    }
    public List<Fruit> findAllFruit(int pageNum){
        return fruitDAO.findAll(pageNum);
    }
    public List<Fruit> findAllFruit(String keyword, int pageNum){
        return fruitDAO.findAll(keyword,pageNum);
    }
}
